export const homeCards = [
    {
        id:"HC1",
        title:"Scratch",
        desc:"An orange cat walking, facing left, with a red double decker bus in the background.",
    ...
    },
    {
        id:"HC2",
        title:"Python",
        desc:"The Python programming language symbol on a midnight blue & purple background.",
    ...
    },
    {
        id:"HC3",
        title:"Web Design",
        desc:"A phone & a computer screen side-by-side on a yellow background.",
        message:"Make digital art, games, and more while exploring one of the world's most popular programming languages.",
...
export const scratchCards = [
    {
        ...
        desc:"A purple background with stars, a planet with a ring around it & a moon, followed by a person with an idea holding a red book, a green cactus and an orange anthropomorphised cat on the left of the image.",
    ...
    },
    {
        id:"SC2",
        title:"More Scratch",
        desc:"A green frog on a blue background, with a white dog on the bottom-right, a wand above the frog, and a red drum, banana, croissant & a green apple around the frog.",
    ...
    },
    {
        ...
        desc:"A computer screen showing a piano keyboard in the center, with a purple robot on the left side & three brown birds on the right, all on a blue skies background with leaves from palm trees.",
...
export const pythonCards = [
    {
        ...
        desc:"A purple starry background with a woman skating in the center of the image, surrounded by a target with an arrow in the center, a yellow smiley face, two snowflakes, an orange tiger face and a rocket.",
    ...
    },
    {
        ...
        desc:"A robot painting some mountains centers this image, with a map in the top-left corner, A woman smiling with a small padlock floating beside her, and a lightbulb in a maze in the top-right corner.",
...
export const webCards = [
    ...
    },
    {
        id:"W2",
        title:"More Web",
        desc:"A white question mark with an aqua blue border, with a hamburger menu symbol in the top-right corner, a small card showing Wonder Woman, a picture of a penguin and a snail on the left-hand side.",
