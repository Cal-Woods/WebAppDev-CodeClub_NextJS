...
export type cardData = {id:string, buttonlink:string, buttontext:string, description:string, title:string, message:string, imglink:string};
export type menuData = {id:string, title:string, link:string};
