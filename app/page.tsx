  ...
  return (
    <div className="w-full h-fit">
      ...
      <div className="w-full h-full flex flex-col md:justify-center align-middle md:flex-row">
        {homeCards.map((el) => {
          return <Card key={el.id} buttonLink={el.buttonLink} buttonText={el.buttonText} description={el.description} imgLink={el.imgLink} title={el.title} message={el.message} />
        })}
      </div>
      <ChristmasWindow />
    </div>
